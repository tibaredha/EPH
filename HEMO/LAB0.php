<?php 
$per ->h(1,500,170,'Bilan Biologique');
$per ->f0('./HEMO/LAB01.PHP','post');

$per ->fieldset("field1","***");$per ->fieldset("field5","***");
$per ->fieldset("BILANHEMO","***");$per ->submit(1070,320,'Imprimer Bilan Biologique');
$per-> mysqlconnect();
$id  = $_GET["idp"] ; 
...
{
$x=250;
$per ->label(50,$x,'Nom :');                   $per ->txt(120,$x,'NOM',20,$result->NOM);
