...
$per ->label(910,$x+142,'إبتدا من');           $per ->txtar(430,$x+142,'DATEIND',20,date("Y-m-d"));    
$per ->hide(595,$x+90,'DATEARRIVE',20,$result->DATEARRIVE);
