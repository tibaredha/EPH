<?php
$per ->h(2,500,175,'REGISTRE SEANCE HEMODIALYSES');
$per-> mysqlconnect();
...
<td class=\"ligne\"><div align=\"center\"><font  color=\"#FFFFFF\" >NOM ET PRENOM</div></td>
...
echo( "<td><div align=\"center\">".$per->nbrtostring("grh","hemo","ID",$result["idp"],"NOM")."_".strtolower($per->nbrtostring("grh","hemo","ID",$result["idp"],"PRENOM"))."</div></td>\n" );
