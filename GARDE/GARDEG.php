...
$query_liste = "SELECT * FROM grh  where cessation !='y' and rnvgradear =5 order by Nomarab ";
...
<h2  align="center" class="hfgh">طبيب عام في الصحة العمومية</h2>
<?php
...
echo( "<form action=\"./garde/RGARDE5.php \" method=\"post\" name=\"form1\">"); 
...
echo( "<td><div align=\"center\">"."<a title=\"ادارة المستخدم \"href=\"index.php?uc=DEMPERG&idp=".$result["idp"]."&Nomlatin=".$result["Nomarab"]."&Prenom_Latin=".$result["Prenom_Arabe"]."&Sexe=".$result["Sexe"]."\"><img src='./images/s_reload.png' width='16' height='16' border='0' alt=''/></a>"."</div></td>\n" );
echo( "</tr>\n" );
} 
