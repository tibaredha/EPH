...
$pdf->SetXY(6.0,5.0);
$pdf->Cell(9.5,1.5,'Liste Nominative Des Malades Hémodialysés /LIT',1,1,'C');
$h=7;
$pdf->SetXY(0.5,$h); 	  
...
$pdf->SetXY(17.5,$h); 	  
$pdf->cell(3,0.5,"N° LIT",1,0,'C',1,0);
...
$query = "SELECT * FROM HEMO where SORTI =''  ORDER BY NLIT";//where SORTI =''
