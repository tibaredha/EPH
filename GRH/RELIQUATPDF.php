...
$pdf->AddPage();
$pdf->Text(11,1,"الجمهورية الجزائرية الديمقراطية الشعبيـة");
$pdf->Text(10.5,2.0,"وزارة الصحة و السكان و إصلاح المستشفيات");
...
$pdf->SetXY(11,7.0);
$pdf->Cell(6.5,1.5,'القائمة الاسمية مع الرصيد من العطل',1,1,'C');
$h=9;
$pdf->SetXY(0.5,$h); 	  
$pdf->cell(7,0.5,"اللقب و الاسم",1,0,'C',1,0);
$pdf->SetXY(7.5,$h); 	  
$pdf->cell(10,0.5,"الرتبة",1,0,'C',1,0);
$pdf->SetXY(17.5,$h); 	  
$pdf->cell(3,0.5,"الرصيد ",1,0,'C',1,0);
$pdf->SetXY(20.5,$h); 	  
$pdf->cell(8,0.5,"المصلحة",1,0,'C',1,0);
