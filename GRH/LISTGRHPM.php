...
$pdf->SetXY(10,7.0);
$pdf->Cell(10,1.5,'القائمة الاسمية للمستخدمين المغادرين  بسبب  النقل',1,1,'C');
...
//********************************************************************************************//
$pdf->mysqlconnect();
$query = "SELECT service.servicear as service,grh.Date_Cessation,grh.Motif_Cessation,grh.servicear,grh.Nomlatin as Nomlatin ,grh.Prenom_Latin as Prenom_Latin,grh.Commune_Naissancear as Commune_Naissancear,grh.Sexe as Sexe ,grh.Date_Naissance as Date_Naissance ,grh.Prenom_Arabe as Prenom_Arabe,grh.Nomarab as Nomarab ,grh.idp as idp,grade.gradear as gradear FROM grh,grade,service where  grade.idg=grh.rnvgradear and  service.ids=grh.servicear and cessation ='y' and Motif_Cessation='7'order by Motif_Cessation";
