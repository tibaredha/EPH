...
<h2  align="center" class="hfgh">ممارس أخصائي مساعد</h2>
<?php
...
echo( "<form action=\"./garde/RGARDE1.php \" method=\"post\" name=\"form1\">"); 
...
echo( "<td><div align=\"center\">"."<a title=\"ادارة المستخدم \"href=\"index.php?uc=DEMPERS&idp=".$result["idp"]."&Nomlatin=".$result["Nomarab"]."&Prenom_Latin=".$result["Prenom_Arabe"]."&Sexe=".$result["Sexe"]."\"><img src='./images/s_reload.png' width='16' height='16' border='0' alt=''/></a>"."</div></td>\n" );
echo( "</tr>\n" );
} 
