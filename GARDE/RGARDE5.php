...
$query = "SELECT service.servicear as service,grh.servicear,grh.Nomlatin as Nomlatin ,grh.Prenom_Latin as Prenom_Latin,grh.Commune_Naissancear as Commune_Naissancear,grh.Sexe as Sexe ,grh.Date_Naissance as Date_Naissance ,grh.Prenom_Arabe as Prenom_Arabe,grh.Nomarab as Nomarab ,grh.idp as idp,grade.gradear as gradear FROM grh,grade,service where  grade.idg=grh.rnvgradear and  service.ids=grh.servicear   and cessation !='y' and grh.rnvgradear=5  order by Nomarab";
...
$pdf->SetXY(7.0,7.5);
$pdf->Cell(6.5,1,'طبيب عام في الصحة العمومية',1,1,'C');
$h=9.5;
$pdf->SetXY(0.5,$h); 	  
