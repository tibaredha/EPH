<?php
$per ->h(2,500,170,'La Liste Nominative Des Patients Sortants');
$per-> mysqlconnect();
$query_liste = "SELECT idp,idpat,nom,prenom,sexe,DATENAISSANCE,DATE,hosp,SERVICEHOSP,HOSP,NLIT,DATESORTIE FROM tpat where SERVICEHOSP!='0' and HOSP ='S' ";
...
<td class=\"ligne\"><div align=\"center\"><font  color=\"#FFFFFF\" >Date entree</div></td>
...
echo( "<td><div align=\"center\">".$result["DATESORTIE"]."</div></td>\n" );
...
echo( "<td><div align=\"CENTER\">"."<a title=\"Gestion Malade\" href=\"index.php?uc=GMS&idp=".$result["idp"]."\"><img src='./images/s_reload.png' width='16' height='16' border='0' alt=''/></a>"."</div></td>\n" );
echo( "</tr>\n" );
}
echo( "<table width=\"85%\" border=\"0\" cellpadding=\"1\" cellspacing=\"1\" align=\"center\">\n" );
echo( "<tr>
