...
$pdf->insertiondis ($AGE,$IDREC,$NOMREC,$PRENOMREC,$SEXE,$pdf->dateUS2FR($DATENAISSANCE),$WILAYA,$COMMUNE,$GROUPAGE,$rhesus,$SERVICE,$MATRICULE,$DOSSIER,$DIAGNOSTIC,$MEDECIN,$datedemdis,$heursdemdis,$QCGR,$QPFC,$QCPS); 
