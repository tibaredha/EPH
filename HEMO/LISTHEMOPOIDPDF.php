...
$pdf->SetXY(6.0,5.0);
$pdf->Cell(9.5,1.5,'Liste Nominative Des Malades Hémodialysés/Poids',1,1,'C');
$h=7;
$pdf->SetXY(0.5,$h); 	  
...
$pdf->SetXY(17.5,$h); 	  
$pdf->cell(3,0.5,"Poids",1,0,'C',1,0);
...
$query = "SELECT * FROM HEMO where SORTI =''  ORDER BY POIDS";//where SORTI =''
...
while($row=mysql_fetch_object($resultat))
  {
    ...
    $pdf->cell(2,1,TRIM($row->SEX),1,0,'C',0);
	$pdf->cell(3,1,$row->POIDS,1,0,'C',0);
