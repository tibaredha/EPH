...
$per ->label(1200+50,$x,'عنوان');      $per ->txtar(1050,$x,'titre',20,"");
$per ->label(1200+50,$x+30,'نوع');     $per ->combo(1050,$x+30,"type","grh","agenda_theme","-----","****","id","TYPEAR");
$per ->label(1200+50,$x+60,'النص');    $per ->textarea1(1050,$x+60,"texte",2,20);
$per ->submit(1050,$x+120,'Envoyer');
