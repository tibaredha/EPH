<?php 
$per ->h(2,400,180,'Modifier  N°SS  Patient Hemodialyse');
$per -> sautligne (2);
$per ->fieldset("field1","Donnees de l'état civil");$per ->fieldset("field5","***");
$per ->photosx(1080,390,'text_bottom.png',150,150);
$per ->f0('index.php?uc=NSS2','post');
