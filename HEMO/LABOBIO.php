...
$per ->h(1,380,190,'Activite Laboratoire d\'Hemodialyse Biochimie');
$per -> sautligne (5);
echo "<form ALIGN=\"center\" action=\"./HEMO/HEMOPDFB.php\" method=\"post\">";
...
echo"</select></p>";
echo"<hr size=8 width=\"700\" COLOR=\"#C0C0C0\"> ";
echo"<p><input type=\"submit\" value=\"imprimer Activite Laboratoire Biochimie \" /></p>  </form>";
echo"<hr size=8 width=\"700\" COLOR=\"#C0C0C0\">";
$per -> sautligne (7);
?>
