<?php
$per ->h(1,470,190,'Activite Laboratoire d\'Hemodialyse');
$per -> sautligne (5);
echo "<form ALIGN=\"center\" action=\"./HEMO/LABORATOIRE1.PHP\" method=\"post\">";
...
echo"</select></p>";
echo"<hr size=8 width=\"700\" COLOR=\"#C0C0C0\"> ";
echo"<p><input type=\"submit\" value=\"imprimer Activite Laboratoire\" /></p>  </form>";
echo"<hr size=8 width=\"700\" COLOR=\"#C0C0C0\">";
$per -> sautligne (7);
?>
