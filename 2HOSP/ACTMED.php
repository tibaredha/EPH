<?php 
$per ->h(1,500,170,'Acte Medical ');
$per ->f0('index.php?uc=ACTMED1','post');
$per ->submit(1110,525,'Acte Medical');
...
$per ->label(50,$x+145,'Acte Medical');        

$per ->label(40,340+100,'Chapitre');           $per ->CHAP(120,340+100,'CHAP','grh','T14');  
$per ->label(40,340+150,'Acte');               $per ->ACTE(120,340+150,'ACTE');  
