...
$pdf->Text(5,4,"MOUVEMENT DU PERSONNEL   service  : ".$servicefr."  date: ".$date);
$h=4.5;
$pdf->SetXY(0.5,$h); 	  
$pdf->cell(4,0.5,"Nom ",1,0,'C',0);

$pdf->SetXY(4.5,$h); 	  
$pdf->cell(4,0.5,"Prenom ",1,0,'C',0);

$pdf->SetXY(8.5,$h); 	  
$pdf->cell(2,0.5,"Present",1,0,'C',0);
...
$pdf->SetXY(17.5,$h); 	  
$pdf->cell(3,0.5,"OBSERVATION",1,0,'C',0);
...
while($row=mysql_fetch_object($resultat))
  {
   $pdf->cell(4,0.5,$row->Nomlatin,1,0,'L',0);//5  =hauteur de la cellule origine =7
   $pdf->cell(4,0.5,$row->Prenom_Latin,1,0,'L',0);
...
$pdf->SetXY(8.5,$pdf->GetY()); 	  
$pdf->cell(2,0.5,"___",1,0,'C',0);

$pdf->SetXY(10.5,$pdf->GetY()); 	  
$pdf->cell(1,0.5,"___",1,0,'C',0);

$pdf->SetXY(11.5,$pdf->GetY()); 	  
$pdf->cell(1,0.5,"___",1,0,'C',0);

$pdf->SetXY(12.5,$pdf->GetY()); 	  
$pdf->cell(1,0.5,"___",1,0,'C',0);

$pdf->SetXY(13.5,$pdf->GetY()); 	  
$pdf->cell(1,0.5,"___",1,0,'C',0);

$pdf->SetXY(14.5,$pdf->GetY()); 	  
$pdf->cell(1,0.5,"___",1,0,'C',0);

$pdf->SetXY(15.5,$pdf->GetY()); 	  
$pdf->cell(1,0.5,"___",1,0,'C',0);

$pdf->SetXY(16.5,$pdf->GetY()); 	  
$pdf->cell(1,0.5,"___",1,0,'C',0);

$pdf->SetXY(17.5,$pdf->GetY()); 	  
$pdf->cell(3,0.5,"____________",1,0,'C',0);



$pdf->SetXY(0.5,$pdf->GetY()); 	  
$pdf->cell(8,0.5,"total effectif :".$totalmbr1,1,0,'C',0);	  
