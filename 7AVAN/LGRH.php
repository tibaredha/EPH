...
$query_liste = "SELECT * FROM grh  where cessation !='y' and PREVISION > $date  order by PREVISION";
...
<td bgcolor=\"#cccccc\"><div align=\"center\">التاريخ التوقعى</div></td>
...
echo( "<td><div align=\"center\">"."<a title=\"ادارة المستخدم \"href=\"index.php?uc=&idp=".$result["idp"]."&Nomlatin=".$result["Nomarab"]."&Prenom_Latin=".$result["Prenom_Arabe"]."&Sexe=".$result["Sexe"]."\"><img src='./images/s_reload.png' width='16' height='16' border='0' alt=''/></a>"."</div></td>\n" );
echo( "</tr>\n" );
} 
