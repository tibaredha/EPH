...
$dataSet->addPoint(new Point("18-19", cdv('M',18,19,$datejour1.'-01-01',$datejour2)));
$dataSet->addPoint(new Point("20-29", cdv('M',20,29,$datejour1.'-01-01',$datejour2)));
$dataSet->addPoint(new Point("30-39", cdv('M',30,39,$datejour1.'-01-01',$datejour2)));
$dataSet->addPoint(new Point("40-49", cdv('M',40,49,$datejour1.'-01-01',$datejour2)));
$dataSet->addPoint(new Point("50-59", cdv('M',50,59,$datejour1.'-01-01',$datejour2)));
$dataSet->addPoint(new Point("60-69", cdv('M',60,69,$datejour1.'-01-01',$datejour2)));
$dataSet->addPoint(new Point("70-79", cdv('M',70,79,$datejour1.'-01-01',$datejour2)));


$chart->setDataSet($dataSet);
$DATE=date("d-m-Y");
$chart->setTitle("Etat Des Dons IND Par Tranche d'age (sexe masculin)  ARRET AU  :".$DATE);
