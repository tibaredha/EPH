<?php 
$per ->h(2,400,180,'Modifier  Lit  Patient Hemodialyse');
$per -> sautligne (2);
$per ->fieldset("field1","Donnees de l'état civil");$per ->fieldset("field5","***");
$per ->photosx(1080,390,'LIT',150,150);
$per ->f0('index.php?uc=MLIT2','post');
...
$per ->label(740,250,'N° Lit');                     $per ->txt(830,250,'NLIT',10,$result->NLIT);
