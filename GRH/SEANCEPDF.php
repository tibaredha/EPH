...
$pdf->Text(80+158,7,"SUIVIE SEANCE ");
$pdf->Text(83+150,12,"Service D'Hemodialyse ");
$pdf->Text(83+150,17,"......................................");
$pdf->Text(80+150,22,"AIN OUSSERA LE :".$dateeuro);
$pdf->SetFont('aefurat', '', 14);
$pdf->Text(30+70,32,"HISTORIQUE SEANCE HEMODIALYSE");
...
$pdf->Text(5,50,"Service:  Hemodialyse");                     $pdf->Text(100+150,50,"Matricule:-------");
$pdf->SetFont('aefurat', '', 10);
$pdf->historiqueseance($idp,59);
// $pdf->historiquebilan0($idp,59+15,"","","","","","","","","","","","","","","","","","","","","","","","","","","");
}
$pdf->Text(80+150,180,"Service : Hemodialyse");
$pdf->Text(80+150,185,"BOUZAHEUR abdelkader");
$pdf->Output();
?>
