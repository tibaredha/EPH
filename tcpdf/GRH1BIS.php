...
//**********************************************************************//
	...
	function entetefr($ndp)
		...
		$this->Text(10,110," Je soussigné certifie etre representant légal de l'enfant désigné si dessus : ");
		...
		$this->Text(10,170,"Nom:....................");
		$this->Text(10,180,"Prenom:....................");
		$this->Text(10,190,"Date De Naissance:....................");
		$this->Text(10,200,"N° CIN PC:....................");
		$this->Text(10,210,"Signature Et Empreinte Digitale");
		$this->Text(120,240,"LE DIRECTEUR");
		$this->Text(10,260,"IMPORTANT : A Garder Dans Le Dossier Médical");
		...
		$this->Text(10,15,"Y COMPRIS LES CONSULTATION EFFECTUEES PAR LES PRATICIENS EXTERNE AU SERVICE");$this->Text(265,10," PAGE 2");
		$this->SetXY(10,20); 	  
        ...
        $this->Text(10,40,"3.Mode de Sortie: Normal");$this->Text(100,40,"4.Code de Sortie:***");
		...
		function PROTOCOLE($ndp,$nom,$prenom,$naissance,$nbrs,$pdialise,$transport,$groupage,$rhesus,$cause)
		{
	    $session=$_SESSION["USER"];
		$this->setPrintHeader(false);
        $this->setPrintFooter(false);
		...
		$this->Text(10,150,"Profil Serologique  :");
		$this->Text(10,160,"Type capillaire  :");
		$this->Text(10,170,"Type Generateur  :");
		$this->Text(10,180,"Poids sec  :");
		$this->Text(10,190,"Prise de poids inter dialytique  :");
		$this->Text(10,200,"Nombre de seance  : ".$nbrs." seances");
		$this->Text(10,210,"Date de la premiere  seance  : ".$pdialise);
