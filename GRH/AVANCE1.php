...
$pdf->SetXY(15,70);
$pdf->Cell(180,8,"مقرر ترقية فى الدرجة",0,1,'C');$pdf->SetFont('aefurat', '', 16);
...
//*********************//
$pdf->SetTextColor(225,0,0);
$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(25,8,$DUREE,1,1,'C');
$pdf->SetXY(30,$pdf->GetY()-8);$pdf->Cell(16,8,$CATEGORIE,1,1,'C');
$pdf->SetXY(46,$pdf->GetY()-8);$pdf->Cell(16,8,$ECHELON,1,1,'C');
$pdf->SetXY(62,$pdf->GetY()-8);$pdf->Cell(40,8,$INDICE,1,1,'C');
$pdf->SetXY(102,$pdf->GetY()-8);$pdf->Cell(30,8,$DATEDEFFET,1,1,'C');

$pdf->SetXY(132,$pdf->GetY()-8);$pdf->Cell(24,8,$A4." سنة ",1,1,'C');
$pdf->SetXY(156,$pdf->GetY()-8);$pdf->Cell(22,8,$M4." شهر ",1,1,'C');
$pdf->SetXY(178,$pdf->GetY()-8);$pdf->Cell(22,8,$J4." يوم ",1,1,'C');
$pdf->SetTextColor(0,0,0);
