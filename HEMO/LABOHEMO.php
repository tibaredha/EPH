...
$per ->h(1,380,190,'Activite Laboratoire d\'Hemodialyse Hématologie');
$per -> sautligne (5);
echo "<form ALIGN=\"center\" action=\"./HEMO/HEMOPDFH.PHP\" method=\"post\">";
...
echo"</select></p>";
echo"<hr size=8 width=\"700\" COLOR=\"#C0C0C0\"> ";
echo"<p><input type=\"submit\" value=\"imprimer Activite Laboratoire Hématologie \" /></p>  </form>";
echo"<hr size=8 width=\"700\" COLOR=\"#C0C0C0\">";
$per -> sautligne (7);
?>
