...
<form action="./garde/DEMPERGP1.php" method="post" name="form1" id="form1">
...
<div style=" position:absolute;left:150px;top:500px;">
	...
	<td/>
	<td>
	<a href="index.php?uc=GARDEGP&idp=<?php ECHO $_GET["idp"]?>&Nomlatin=<?php echo($result->Nomarab) ;?>&Prenom_Latin=<?php echo($result->Prenom_Arabe) ;?>&Sexe=<?php echo($result->Sexe);?>"><img src='./images/b_home.png' width='16' height='16' border='0' alt=''/>طبيب عام رئيسي في الصحة العمومية</a>
