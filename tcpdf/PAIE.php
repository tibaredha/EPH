...

{
    ...
    $query = "SELECT grh.cessation ,service.servicear as service,grh.ECHELON,grh.CATEGORIE,grh.RELIQUAT,grh.DATEDEFFET,grh.INDICE,grh.DATEDECISION,grh.NDECISION,grh.Nomlatin as Nomlatin ,grh.Prenom_Latin as Prenom_Latin,grh.Commune_Naissancear as Commune_Naissancear,grh.Sexe as Sexe ,grh.Date_Naissance as Date_Naissance ,grh.Prenom_Arabe as Prenom_Arabe,grh.Nomarab as Nomarab ,grh.idp as idp,grade.gradear as gradear FROM grh,grade,service where cessation !='y' and grade.idg=grh.rnvgradear and  service.ids=grh.servicear  and CATEGORIE='$CATEGORIE'     order by ECHELON";
...
function titre()
    ...
    $this->SetXY(120,70);
    $this->Cell(65,15,'البيان الاصلى الاولى  ',1,1,'C');
...
$h=111.5;
$this->SetXY(05,$h2);
$this->cell(20,12,"الصنف:".$CAT,1,0,'C',1,0);
$this->SetXY(05,$h1); 	  
$this->cell(10,12,"الرقم",1,0,'C',1,0);
$this->SetXY(15,$h1); 	  
$this->cell(20,12,"اللقب",1,0,'C',1,0);
$this->SetXY(35,$h1); 	  
$this->cell(20,12,"الاسم",1,0,'C',1,0);

$this->SetXY(55,$h1); 	  
$this->cell(89,06.5,"اخر ترقية فى الرتبة التالية",1,0,'C',1,0);


$this->SetXY(55,$h); 	  
$this->cell(30,5,"رقم و تاريخ المقرر",1,0,'C',1,0);
$this->SetXY(85,$h); 	  
...
$this->SetXY(144,$h1); 	  
$this->cell(36,6.5,"الاقدمية المحتفض بها",1,0,'C',1,0);
...
$this->SetXY(180,$h1); 	  
$this->cell(36,06.5,"الاقدمية  الجديدة",1,0,'C',1,0);
...
$this->cell(12,05,"سنة",1,0,'C',1,0);
$this->SetXY(216,$h1); 	  
$this->cell(30,12,"النقطة السنوية",1,0,'C',1,0); 
$this->SetXY(05,117); // marge sup 13   
