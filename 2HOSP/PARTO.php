...
$AGEEXT=$_POST["AGEEXT"];
$LDA=$_POST["LDA"];
$ND=$_POST["ND"];$DATEND=$_POST["DATEND"];
...
$pdf->Text(5,5+2,"Nom,Prénom : ".$_POST["NOM"]."_".$_POST["PRENOM"]);       $pdf->Text(80,5+2,"Geste : ".$geste);             $pdf->Text(110,5+2,"Parité : ".$parite);                $pdf->Text(140,5+2,"Hopital N° : AIN OUSSERA");
$i=9+2;
$pdf->Line(5 ,$i,200 ,$i );
$pdf->Text(5,10+2,"Date D'admission : ".$_POST["DATEADMISSION"]);            $pdf->Text(80,10+2,"Heure D'admission : ".$_POST["HEURE"]." heures");                            $pdf->Text(140,10+2,"Rupture Des Membranes");
$i=14+2;
$pdf->Line(5 ,$i,200 ,$i );
